---
description: >-
  Giới thiệu LLM7.io — API chat tương thích OpenAI SDK, miễn phí hoặc Pro $12/tháng,
  hỗ trợ streaming, JSON mode, function calling và image recognition.
---
...
## **LLM7 là gì?** <a href="#llm7-la-gi" id="llm7-la-gi"></a>
...
## **Tính năng chính** <a href="#tinh-nang-chinh" id="tinh-nang-chinh"></a>
...
## **Bảng so sánh các gói** <a href="#so-sanh-goi" id="so-sanh-goi"></a>
...
## **Hướng dẫn bắt đầu** <a href="#huong-dan" id="huong-dan"></a>
...
{% tabs %}
{% tab title="Anonymous (không cần đăng ký)" %}
...
{% endcode %}
{% endtab %}
{% tab title="Free Token / Pro Token" %}
{% code title="Python" overflow="wrap" lineNumbers="true" %}
```python
import openai
...
## **JSON Mode** <a href="#json-mode" id="json-mode"></a>
...
## **Image Recognition** <a href="#image-recognition" id="image-recognition"></a>
...
## **Models API — Kiểm tra model realtime** <a href="#models-api" id="models-api"></a>
...
## **Ưu và nhược điểm** <a href="#uu-nhuoc-diem" id="uu-nhuoc-diem"></a>
...
## **Lưu ý quan trọng** <a href="#luu-y" id="luu-y"></a>
