...
description: >-
  ...
  tạo ảnh, video, TTS và WordPress Plugin. White-Label, không lock-in nhà cung cấp.
---
...
## **Thông số kết nối API** <a href="#thong-so-ket-noi" id="thong-so-ket-noi"></a>
...
## **API Chat** <a href="#api-chat" id="api-chat"></a>
...
## **API: Image Generation** <a href="#api-image" id="api-image"></a>
...
## **API: Text-to-Speech (TTS)** <a href="#api-tts" id="api-tts"></a>
...
## **API: Video Generation** <a href="#api-video" id="api-video"></a>
...
## **Pricing & Token Usage** <a href="#pricing" id="pricing"></a>
